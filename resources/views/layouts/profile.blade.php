...
<body>
    ...
    <nav class="top-nav">
        ...
        <div class="nav-menu">
            ...
            <a href="{{ route('donasi') }}" class="nav-link {{ request()->routeIs('donasi') ? 'active' : '' }}" >Donasi</a>
            <a href="{{ route('profile') }}" class="nav-link profile-btn {{ request()->routeIs('profile') ? 'active' : '' }}" >PROFILE</a>
        </div>
    </nav>
